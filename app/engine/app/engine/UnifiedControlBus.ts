// app/engine/UnifiedControlBus.ts — V19.2.4 FIELD_OS
...
export class UnifiedControlBus{
  ...
  ingest(i:{dmx:number}){const d=Math.min(Math.max(i.dmx,0),1); this.target.dmx=d; this.target.flow=0.3+d*0.6; this.target.propulsion=d*0.5; this.target.sat=0.2+d*0.6; this.target.inner=0.3+d*0.5; this.target.bloom=0.1+d*0.8; if(d>0.95) this.glitchTimer=0.15;}
